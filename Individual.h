/*----------------------------------------------------------------------------
 *
 *	Copyright (C) 2026 Greta Bocedi, Stephen C.F. Palmer, Justin M.J. Travis, Anne-Kathleen Malchow, Roslyn Henry, Th�o Pannetier, Jette Wolff, Damaris Zurell
 *
...
private:
	...
	short status;	
		...
		// 10 = translocated to a different patch (e.g. for assisted colonisation)
		// 11 = harvested (e.g. to regulate population size or for hunting)
