...
#pragma resource "*.dfm"
TfrmVisualTraits0 *frmVisualTraits0;
//---------------------------------------------------------------------------
__fastcall TfrmVisualTraits0::TfrmVisualTraits0(TComponent* Owner)
	: TForm(Owner)
{
 frmVisualTraits0->Left = 200;
 frmVisualTraits0->Top = 200;
}

void __fastcall TfrmVisualTraits0::refresh(int height) {
...
void __fastcall TfrmVisualTraits0::setImage(int panel,UnicodeString titletext,
...
void __fastcall TfrmVisualTraits0::drawImage(int panel,Graphics::TBitmap *map) {
TImage *image;
