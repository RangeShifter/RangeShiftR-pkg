...
RangeShifter v2.0 FormVisualTraits0H

Displays Traits form 0
...
#ifndef FormVisualTraits0H
#define FormVisualTraits0H
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
class TfrmVisualTraits0 : public TForm
{
...
public:		// User declarations
	__fastcall TfrmVisualTraits0(TComponent* Owner);
...
//---------------------------------------------------------------------------
extern PACKAGE TfrmVisualTraits0 *frmVisualTraits0;
//---------------------------------------------------------------------------
#endif
