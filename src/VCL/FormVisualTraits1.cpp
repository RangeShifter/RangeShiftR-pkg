...
#pragma resource "*.dfm"
TfrmVisualTraits1 *frmVisualTraits1;
//---------------------------------------------------------------------------
__fastcall TfrmVisualTraits1::TfrmVisualTraits1(TComponent* Owner)
	: TForm(Owner)
{
 frmVisualTraits1->Left = 200;
 frmVisualTraits1->Top = 200;
}

void __fastcall TfrmVisualTraits1::refresh(int height) {
...
void __fastcall TfrmVisualTraits1::setImage(int panel,UnicodeString titletext,
...
void __fastcall TfrmVisualTraits1::drawImage(int panel,Graphics::TBitmap *map) {
TImage *image;
