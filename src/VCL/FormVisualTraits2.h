...
RangeShifter v2.0 FormVisualTraits2H

Displays Traits form 2
...
#ifndef FormVisualTraits2H
#define FormVisualTraits2H
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
class TfrmVisualTraits2 : public TForm
{
...
public:		// User declarations
	__fastcall TfrmVisualTraits2(TComponent* Owner);
...
//---------------------------------------------------------------------------
extern PACKAGE TfrmVisualTraits2 *frmVisualTraits2;
//---------------------------------------------------------------------------
#endif
