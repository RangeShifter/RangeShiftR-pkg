...
.onAttach <- function(libname, pkgname) {
    packageStartupMessage("RangeshiftR version 1.0.5 (17.01.2025)\n",
                          "Copyright (C) 2020-2022 Anne-Kathleen Malchow, Jette Reeg, Greta Bocedi, Stephen C.F. Palmer, Justin M.J. Travis, Damaris Zurell\n\n",
...
{
    cat("\nRangeshiftR version 1.0.5 (17.01.2025)\n")
    cat("Copyright (C) 2020-2022 Anne-Kathleen Malchow, Jette Reeg, Greta Bocedi, Stephen C.F. Palmer, Justin M.J. Travis, Damaris Zurell\n\n")
