...
#'     \item \code{combinekernels= TRUE} - ...combining both kernels, i.e. \ifelse{html}{ \out{p(d; &delta;<sub>1</sub>,&delta;<sub>2</sub>) = p<sub>I</sub> p(d;&delta;<sub>1</sub>) + (1-p<sub>I</sub>) p(d;&delta;<sub>1</sub>) } }{\deqn{ p(d; \delta_1,\delta_2) = p_I p(d;\delta_1) + (1-p_I) p(d;\delta_2)} }
#'   }
...
#'   E.g. for stage 1:  \ifelse{html}{\out{&sigma;<sub>1</sub> = sum( &sigma;<sub>1</sub> (1-&gamma;<sub>1-2</sub>),  &sigma;<sub>1</sub> &gamma;<sub>1-2</sub>}}{\eqn{\sigma_1 = sum(\sigma_1 (1 - \gamma_(1-2)), \sigma_1 \gamma_(1-2))}}
#'
...
#'   E.g. for stage 1: \ifelse{html}{\out{&gamma;<sub>1-2</sub> = &sigma;<sub>1</sub> &gamma;<sub>1-2</sub> / &sigma;<sub>1</sub>}}{\eqn{\gamma_(1-2) = \sigma_1 / (\sigma_1 \gamma_(1-2) )}}
#' }
#' @export
