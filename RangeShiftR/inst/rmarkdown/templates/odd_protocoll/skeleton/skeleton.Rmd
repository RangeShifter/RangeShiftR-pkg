...
![General model workflow and schedule. The core of the model highlighted in blue is expanded in the flow chart in Fig. 2](./RS_flowchart.png){width=50%, height=50%}

\newpage

![General flowchart of the core model](./RS_flowchart_2.png){width=50%, height=50%}
...
`r if(cell_based & dispersal_kernel & s@dispersal@Settlement@Settle>=2){"Dispersing individuals perceive the suitability of cells and might settle in a suitable neighbouring cell if the arrival cell is unsuitable."}`
`r if(patch_based & dispersal_kernel & s@dispersal@Settlement@Settle>=2){"Dispersing individuals perceive the suitability of patches and might settle in a suitable neighbouring patch if the arrival patch is unsuitable."}`
