...
![General model workflow and schedule. The settings of this specific use case may not include all available submodules. Only relevant submodules are described in this document. The core of the model highlighted in blue is expanded in the flow chart in Fig. 2](./RSflowchart_big.png){height=60%}

\newpage

![General flowchart of the core model. `r if(!genetics){"The settings of this studies' specific use case do not include genetics, i.e. individual variability o trait evolution. "}`Only relevant submodules are described in this document.](./RSflowchart_detail.png){height=60%}
