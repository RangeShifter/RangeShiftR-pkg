...
`r if(translocation){"Translocation, the intentional capture of animals and following release in new areas, are a common conservation practice. They are used to establish new populations, to increase the size of small populations, to reintroduce species in areas where they have been extirpated, and to increase genetic diversity. 
- indidivduals are selected by characteristics
