...
![General model workflow and schedule. The core of the model highlighted in blue is expanded in the flow chart in Fig. 2](./RSflowchart_big.png){height=70%}

\newpage

![General flowchart of the core model](./RSflowchart_detail.png){height=70%}
...
if(translocation) knitr::kable(Management, col.names = gsub("[.]", " ", names(Management)), caption = 'Management parameters')
